<div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">            
            <?php echo form_open('Barang/ubah_barang/'.$item['id_barang']); ?>
            <div class="box-body">
                    ...
                    <option value="<?php echo $cat['id_kategori'] ?>"
                      <?php
                        if (isset($_POST['id_kategori'])) {
                          if ($cat['id_kategori'] == $_POST['id_kategori']) {
                            echo 'selected="selected"';
                          }
                        } else if ($cat['id_kategori'] == $item['id_kategori']) {
                          echo 'selected="selected"';
                        }
                  ...
                  <option value="<?php echo $brd['id_merek'] ?>"
                    <?php
                      if (isset($_POST['id_merek'])) {
                        if ($brd['id_merek'] == $_POST['id_merek']) {
                          echo 'selected="selected"';
                        }
                      } else if ($brd['id_merek'] == $item['id_merek']) {
                        echo 'selected="selected"';
                      }
                  ...
                  <option value="<?php echo $uni['id_satuan'] ?>"
                    <?php
                      if (isset($_POST['id_satuan'])) {
                        if ($uni['id_satuan'] == $_POST['id_satuan']) {
                          echo 'selected="selected"';
                        }
                      } else if ($uni['id_satuan'] == $item['id_satuan']) {
                        echo 'selected="selected"';
                      }
